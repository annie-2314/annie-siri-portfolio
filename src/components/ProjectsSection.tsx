        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {projects.map((project, index) => {
            ...
            return (
              <div
                key={project.id}
                className={`group relative bg-card rounded-2xl p-8 shadow-soft border border-border hover:shadow-strong transition-all duration-500 hover:-translate-y-2 animate-slide-up ${
              ...
              >
                {/* Featured Badge */}
                {project.featured && (
                  <div className="absolute -top-3 -right-3 bg-gradient-primary text-primary-foreground px-3 py-1 rounded-full text-xs font-semibold shadow-medium">
                    Featured
                  </div>
                )}
