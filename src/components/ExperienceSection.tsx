...
const ExperienceSection = () => {
  const achievements = ['Developed and optimized AI context management systems for improved model performance', 'Implemented automated workflow pipelines reducing processing time by 40%', 'Collaborated on multi-agent AI systems with advanced planning and feedback mechanisms', 'Created intelligent error recovery systems for robust data processing workflows', 'Contributed to research on adaptive learning algorithms and personalization techniques'];
  return <section id="experience" className="py-20 bg-gradient-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6">
              My <span className="bg-gradient-primary bg-clip-text text-slate-950">Experience</span>
            </h2>
          ...
          <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-strong border border-border animate-slide-up">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 text-muted-foreground">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">Hyderabad
                </span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid gap-4">
                {achievements.map((achievement, index) => <div key={index} className="flex items-start space-x-3 animate-slide-up" style={{
            ...
            <div className="mt-8 pt-8 border-t border-border">
              ...
              <div className="flex flex-wrap gap-3">
                {['Python', 'Machine Learning', 'LangGraph', 'Groq LLM', 'Context Management', 'Workflow Automation', 'AI Agents', 'Error Recovery Systems', 'Data Processing'].map(skill => <span key={skill} className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium hover:bg-primary/20 transition-colors duration-200">
                    {skill}
                  </span>)}
              </div>
            </div>
